# toolchains/arm-none-eabi/linux/config.bzl

load("@bazel_tools//tools/build_defs/cc:action_names.bzl", "ACTION_NAMES")
load("@bazel_tools//tools/cpp:cc_toolchain_config_lib.bzl", "feature", "flag_group", "flag_set", "tool_path")

ARM_NONE_EABI_PATH = "external/arm-none-eabi-linux"
ARM_NONE_EABI_VERSION = "9.2.1"

def wrapper_path(tool):
    return "arm-none-eabi/linux/arm-none-eabi-{}".format(tool)
...
cc_arm_none_eabi_linux_config = rule(
