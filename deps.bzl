...
def arm_none_eabi_deps():
    http_archive(
        ...
        build_file = "@arm_none_eabi//toolchain/arm-none-eabi/darwin:compiler.BUILD",
    ...
    http_archive(
        ...
        build_file = "@arm_none_eabi//toolchain/arm-none-eabi/linux:compiler.BUILD",
    ...
    http_archive(
        ...
        build_file = "@arm_none_eabi//toolchain/arm-none-eabi/windows:compiler.BUILD",
